      ...
      <form action="db.php" method="POST">
        <table class = "table table-striped mt-3">
          ...
          <tbody>
            ...
            <td scope = "col"><?php echo $row['fname'];?></td>
            ...
            <td scope = "col">
              <form action = "db.php" method = "POST">
                  ...
                  <button type  = "submit" name="editmang" class = "btn btn-primary">Edit Question</button>
                  <button type= "submit" name="quesfet" class = "btn btn-success">Add Solution </button>
                  <button type  = "submit" name="viewsolution" class = "btn btn-success mt-2">View Solution</button>
                  <button type  = "submit" name="download" class = "btn btn-primary mt-2"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Download Question</button>
              </form>
            </td>
          </tbody>
          <?php }
