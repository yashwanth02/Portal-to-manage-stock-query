      ...
      <form method="POST" action="db.php">
        <table class = "table table-striped mt-3">
          ...
          <tbody>
            ...
            <td scope = "col"><?php echo $row['sol'];?></td>
            <td scope = "col"><?php echo $row['lang'];?></td>
            <td scope = "col"><?php echo $row['yes_no'];?></td>
            <td scope = "col">
            <form action = "db.php" method = "POST">
              <!-- <a type  = "button" href = "#" class = "btn btn-primary">View Question</a> -->
              <input type = "hidden" value = "<?php echo $row['sid'];?>" name = "sid">
              <button type  = "submit" name="editsolution" class = "btn btn-primary">Edit Solution</button>
              <button type  = "submit" name="download-sol" class = "btn btn-success"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Download Solution</button>
            </form>
          </tbody>
          <?php }
          ?>
